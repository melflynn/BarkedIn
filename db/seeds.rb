...
reactions = Reaction.create([
  {post_id: Post.where(author_id: demo_user.id).limit(1).pluck(:id)[0], liker_id: goose.id, reaction_type: 'wag'},
  {post_id: Post.where(author_id: demo_user.id).limit(1).pluck(:id)[0], liker_id: duke.id, reaction_type: 'high five'},
  {post_id: Post.where(author_id: demo_user.id).limit(1).pluck(:id)[0], liker_id: athena.id, reaction_type: 'wag'},
  {post_id: Post.where(author_id: demo_user.id).limit(1).offset(1).pluck(:id)[0], liker_id: athena.id, reaction_type: 'throw a bone'},
  {post_id: Post.where(author_id: demo_user.id).limit(1).offset(2).pluck(:id)[0], liker_id: goose.id, reaction_type: 'high five'},
  {post_id: Post.where(author_id: demo_user.id).limit(1).offset(2).pluck(:id)[0], liker_id: duke.id, reaction_type: 'wag'},
  {post_id: Post.where(author_id: goose.id).limit(1).pluck(:id)[0], liker_id: soba.id, reaction_type: 'throw a bone'},
  {post_id: Post.where(author_id: goose.id).limit(1).pluck(:id)[0], liker_id: athena.id, reaction_type: 'throw a bone'},
  {post_id: Post.where(author_id: goose.id).limit(1).offset(1).pluck(:id)[0], liker_id: athena.id, reaction_type: 'high five'},
  {post_id: Post.where(author_id: goose.id).limit(1).offset(1).pluck(:id)[0], liker_id: demo_user.id, reaction_type: 'high five'},
  {post_id: Post.where(author_id: goose.id).limit(1).offset(3).pluck(:id)[0], liker_id: teak.id, reaction_type: 'high five'},
  {post_id: Post.where(author_id: goose.id).limit(1).offset(3).pluck(:id)[0], liker_id: koby.id, reaction_type: 'wag'},
  {post_id: Post.where(author_id: koby.id).limit(1).pluck(:id)[0], liker_id: lyla.id, reaction_type: 'wag'},
  {post_id: Post.where(author_id: koby.id).limit(1).offset(1).pluck(:id)[0], liker_id: goose.id, reaction_type: 'throw a bone'},
  {post_id: Post.where(author_id: athena.id).limit(1).pluck(:id)[0], liker_id: goose.id, reaction_type: 'wag'},
  {post_id: Post.where(author_id: athena.id).limit(1).offset(1).pluck(:id)[0], liker_id: goose.id, reaction_type: 'wag'},
  {post_id: Post.where(author_id: athena.id).limit(1).offset(1).pluck(:id)[0], liker_id: demo_user.id, reaction_type: 'wag'},
  {post_id: Post.where(author_id: teak.id).limit(1).pluck(:id)[0], liker_id: soba.id, reaction_type: 'wag'},
  {post_id: Post.where(author_id: teak.id).limit(1).pluck(:id)[0], liker_id: lily.id, reaction_type: 'high five'},
  {post_id: Post.where(author_id: teak.id).limit(1).offset(1).pluck(:id)[0], liker_id: goose.id, reaction_type: 'high five'},
  {post_id: Post.where(author_id: soba.id).limit(1).pluck(:id)[0], liker_id: goose.id, reaction_type: 'high five'},
  {post_id: Post.where(author_id: soba.id).limit(1).pluck(:id)[0], liker_id: lily.id, reaction_type: 'wag'},
  {post_id: Post.where(author_id: soba.id).limit(1).pluck(:id)[0], liker_id: lily.id, reaction_type: 'wag'},
  {post_id: Post.where(author_id: soba.id).limit(1).offset(1).pluck(:id)[0], liker_id: lily.id, reaction_type: 'wag'},
  {post_id: Post.where(author_id: soba.id).limit(1).offset(2).pluck(:id)[0], liker_id: teak.id, reaction_type: 'wag'},
  {post_id: Post.where(author_id: lily.id).limit(1).pluck(:id)[0], liker_id: goose.id, reaction_type: 'throw a bone'},
])
